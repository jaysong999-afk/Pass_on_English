...
function mapDbCountry(country: CountryCode): "KR" | "CN" {
  return country === "CN" ? "CN" : "KR";
}
...
const SELECT_COLUMNS =
  "id, account_holder_name, account_email, account_phone, account_type, country, learner_full_name, learner_english_name, learner_date_of_birth, english_level, purposes, status, submitted_at, reviewed_at, reviewed_by";
